...
export default function Layout({ children }) {
  ...
  return (
    <>
      ...
      <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', fontFamily: 'Nunito, sans-serif', backgroundColor: T.bg, transition: 'background-color 0.3s ease' }}>
        ...
        <header style={{
          ...
          {/* Logo — lebar sama dengan sidebar agar rata */}
          <div style={{ width: 220, minWidth: 220, display: 'flex', alignItems: 'center', flexShrink: 0 }}>
            <img src={Logo} alt="LombaIn" style={{ height: 35, width: 'auto' }} />
            <span style={{ fontWeight: 900, fontSize: 18, letterSpacing: '-0.5px', lineHeight: 1 }}>
  ...
  onChange={e => {
    ...
    navigate(`/dashboard?q=${e.target.value}`);
  }}
  style={{ flex: 1, border: 'none', background: 'transparent', fontWeight: 600, fontSize: 13, color: T.searchText, outline: 'none', fontFamily: 'inherit' }}
/>
{searchQuery && (
  <button onClick={() => { setSearchQuery(''); navigate('/dashboard'); }}
    style={{ background: 'none', border: 'none', cursor: 'pointer', color: T.textMuted, fontSize: 18, lineHeight: 1, padding: 0 }}>
    ×
  </button>
)}
          </div>
        ...
        <div style={{ display: 'flex', flex: 1 }}>
            ...
            <nav style={{ flex: 1, padding: '16px 8px', display: 'flex', flexDirection: 'column', gap: 4 }}>
              ...
              <div style={{ margin: '8px 0 4px', padding: '0 6px' }}>
                ...
                <button className="theme-toggle" onClick={toggleTheme}
                  style={{ display: 'flex', alignItems: 'center', gap: 12, width: '100%', padding: '11px 14px', fontWeight: 800, fontSize: 14, color: 'rgba(255,255,255,0.7)', borderRadius: 12, background: 'none', border: 'none', cursor: 'pointer', transition: 'all 0.2s' }}
          ...
          {/* ══════════ KONTEN UTAMA ══════════ */}
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0, transition: 'background-color 0.3s ease' }}>
            {children}
          </div>
        </div>
